...
app.get('/manifest.json', (req, res) => {
  ...
  // iOS/macOS Swift clients send CFNetwork or Darwin in their User-Agent.
  // Android clients use OkHttp (e.g. "okhttp/4.x") — no "android" keyword.
  // Default to object format (Android Gson-safe).
  // Only use plain strings when we positively identify a Swift/iOS client.
