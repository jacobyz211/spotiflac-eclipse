...
<head>
  ...
  <title>Deezer — Eclipse Addon</title>
...
<body>
  <nav>
    <div class="brand"><div class="dot"></div>Deezer</div>
  ...
  <footer>Deezer \u00b7 Deezer + Claudochrome \u00b7 Eclipse Music Addon</footer>
  <script>
...
// ─── Start ────────────────────────────────────────────────────
app.listen(PORT, () => {
  console.log(`Deezer v5.5.0 → http://localhost:${PORT}`);
